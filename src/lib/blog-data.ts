...
export const blogTopics = {
    "Teknologi": [
        "Keuntungan Internet Fiber Optic Dibandingkan Teknologi Lama",
        "Apa Itu Kecepatan Internet Simetris dan Mengapa Anda Membutuhkannya?",
        "Cara Mengoptimalkan Jaringan Wi-Fi di Rumah Anda",
        "Masa Depan Internet di Indonesia: Prediksi dan Tren",
        "Mengapa Latensi Rendah (Low Latency) Penting untuk Gaming dan Video Call",
    ],
    "Gaming": [
        "5 Game Online yang Paling Membutuhkan Koneksi Internet Cepat",
        "Cara Mengatasi Lag Saat Bermain Game Online",
        "Review Paket MyGamer: Apakah Layak untuk Para Gamer?",
        "Tips Memilih Router Terbaik untuk Kebutuhan Gaming Anda",
        "Esports di Malang: Perkembangan dan Potensinya",
    ],
    "Hiburan": [
        "Rekomendasi Film dan Serial TV Terbaik untuk Ditonton di Akhir Pekan",
        "Cara Menikmati Streaming Konten 4K Tanpa Buffering",
        "Membandingkan Layanan Streaming Populer di Indonesia: Netflix, Disney+, Vidio",
        "Manfaat Memiliki Paket Internet dan TV Kabel dalam Satu Tagihan",
        "Panduan Membangun Home Theater Impian dengan Budget Terjangkau",
    ],
    "Gaya Hidup & Produktivitas": [
        "Tips Efektif Bekerja dari Rumah (Work From Home) dengan Koneksi Andal",
        "Pentingnya Internet Cepat untuk Mendukung Pendidikan Anak",
        "Cara Memanfaatkan Internet untuk Mengembangkan Usaha Kecil (UMKM)",
        "Panduan Keamanan Digital: Melindungi Keluarga Anda dari Ancaman Online",
        "5 Aplikasi yang Wajib Dimiliki untuk Produktivitas Harian",
    ],
    "Lokal (Malang)": [
        "Tempat-tempat di Malang dengan Wi-Fi Gratis yang Nyaman untuk Bekerja",
        "Perkembangan Startup Teknologi di Kota Malang",
        "Event Komunitas Gamer yang Wajib Dikunjungi di Malang",
        "MyRepublic: Turut Membangun Infrastruktur Digital di Malang Raya",
        "Cerita Sukses UMKM Malang yang Go Digital Bersama Internet Cepat",
    ]
};
